                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            {!! Form::label('title', __('Job Title'),['class'=>'form-label']) !!}<span class="text-danger pl-1">*</span>
                        ...
                        <div class="form-group col-md-6">
                            {!! Form::label('category', __('Job Category'),['class'=>'form-label']) !!}<span class="text-danger pl-1">*</span>
                            {{ Form::select('category', $categories,null, array('class' => 'form-control select','required'=>'required')) }}
                        </div>
                        <div class="form-group col-md-6">
                            {!! Form::label('position', __('No. of Positions*'),['class'=>'form-label']) !!}<span class="text-danger pl-1">*</span>
                        ...
                        <div class="form-group col-md-12">
                             <label class="col-form-label" for="skill">{{ __('Skill Box') }}</label><span class="text-danger pl-1">*</span>
