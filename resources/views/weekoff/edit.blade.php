...
{{ Form::model($weekoff, ['route' => ['weekoff.update', $weekoff->id], 'method' => 'PUT']) }}
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('week_off_date', __('Week Off Date'), ['class' => 'col-form-label']) }}
                {{ Form::text('week_off_date', null, ['class' => 'form-control d_week', 'autocomplete' => 'off']) }}
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                @endif
                {{ Form::textarea('remark', null, ['class' => 'form-control grammer_textarea', 'placeholder' => __('Week Off Remark'), 'rows' => '3']) }}
            </div>
        </div>
    </div>
    @role('Company')
