...
<head>
    ...
    color: #070707;
    position: relative;
    background-image: url("{{ asset('/assets/images/lightcolor.jpg') }}");
    ...
    background-position: center;
        ...
        .id-card-back {
            ...
            color: #070707;
            position: relative;
            background-image: url("{{ asset('/assets/images/idcardback.jpg') }}"); 
            background-size: cover; 
            background-position: center;
        ...
        <div class="row">
            <div class="col-6">
                <div class="id-card">
                    <div class="photo" style="">
                        <img src="https://hrm.junglesafariindia.in/storage/uploads/avatar/{{$data['photo']}}" alt="Photo" >
                    </div>
                    <div class="info">
                        <div class="name">
                            <h5 class="employee_name">{{$data['name']}}</h5>
                            <p class="designation">{{$data['designation']}}</p>
                        </div>
                        <div>
                            <ul type="none">
                                <li style="font-size: 15px;"><strong>ID NO</strong><span style="margin-left: 5px;">: {{$data['id_no']}}</span></li>
                                <li style="font-size: 15px;"><strong>Join Date</strong> <span style="margin-left: 5px;">: {{$data['join_date']}}</span></li>
                                <li style="font-size: 15px;"><strong>Phone</strong><span style="margin-left: 5px;">: {{$data['phone']}}</span></li>
                                <li style="font-size: 13px;"><strong>Email</strong><span style="margin-left: 5px;">: {{$data['email']}}</span></li>
                        ...
                        <div class="qrimage">
                            <div class="qrimage">
                                {!! QrCode::size(40)->generate("EMP NAME: " . $data['name'] . ", EMP ID: " . $data['id_no']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="footer">
            ...
            <div class="col-6">
                <div class="id-card-back ">
                    ...
                    <div class="qrimage2">
                            <div class="qrimage2">
                                {!! QrCode::size(70)->generate('https://junglesafariindia.in/') !!}
                            </div>
                    </div>
