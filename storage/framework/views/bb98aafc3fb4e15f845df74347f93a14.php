...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            <!-- timesheet-->
            <?php if(Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage Weekoff') || Gate::check('Manage TimeSheet')): ?>
                <li class="dash-item dash-hasmenu <?php echo e(Request::segment(2) == 'leave' || Request::segment(2) == 'Weekoff' ? 'dash-trigger active' : ''); ?>">
                <a href="#!" class="dash-link"><span class="dash-micon"><i
                    ...
                    <ul class="dash-submenu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Leave')): ?>
                            <li class="dash-item <?php echo e(Request::segment(2) == 'leave' || Request::segment(2) == 'Weekoff' ? ' active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('leave.index')); ?>"><?php echo e(__('Manage Leave')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Weekoff')): ?>
                            <li class="dash-item <?php echo e(Request::segment(2) == 'leave' || Request::segment(2) == 'Weekoff' ? ' active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('weekoff.index')); ?>"><?php echo e(__('Manage Weekoff')); ?></a>
                            </li>
                        <?php endif; ?>
            ...
            <?php if(Gate::check('Manage Awards') ||
                ...
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext"><?php echo e(__('Additional Features')); ?></span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="dash-submenu">
...
<?php /**PATH /var/www/html/hrm-systemjan8/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>