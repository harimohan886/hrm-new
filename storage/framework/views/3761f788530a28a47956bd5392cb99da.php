                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="d-flex align-items-center justify-content-end ">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->type == 'company' || Auth::user()->type == 'hr'): ?>
                                <?php echo e(Form::open(['route' => ['payslip.export.banksheet'], 'method' => 'POST', 'id' => 'payslip_form_banksheet', 'style' => 'margin-left:10px;'])); ?>

                                <input type="hidden" name="filter_month" class="filter_month">
                                <input type="hidden" name="filter_year" class="filter_year">
                                <input type="submit" value="<?php echo e(__('Export BankSheet')); ?>" class="btn btn-primary">
                                <?php echo e(Form::close()); ?>

                            <?php endif; ?>
                            <?php if(Auth::user()->type == 'company' || Auth::user()->type == 'hr'): ?>
                                <?php echo e(Form::open(['route' => ['payslip.delete.all'], 'method' => 'POST', 'id' => 'payslip_delete_all', 'style' => 'margin-left:10px;'])); ?>

                                <input type="hidden" name="filter_month" class="filter_month">
                                <input type="hidden" name="filter_year" class="filter_year">
                                <input type="submit" value="<?php echo e(__('Delete All')); ?>" class="btn btn-danger">
                                <?php echo e(Form::close()); ?>
                        ...
                        function renderButton(data, cell, row) {
                            ...
                            if (data != 0) {
                                var payslip =
                                    ...
                                    '/' + datePicker +
                                    '" data-size="md-pdf"  data-ajax-popup="true" class="btn btn-primary d-none" data-title="<?php echo e(__('Employee Payslip')); ?>">' +
                            ...
                            if (data != 0 && status == "UnPaid") {
                                edit =
                                    ...
                                    payslip_id +
                                    '"  data-ajax-popup="true" class="view-btn blue-bg d-none" data-title="<?php echo e(__('Edit Employee salary')); ?>">' +
                            ...
                            $.each(data, function(indexInArray, valueOfElement) {
                                ...
                                if (valueOfElement[7] != 0) {
                                    var payslip =
                                        ...
                                        id +
                                        '/' + datePicker +
                                        '" data-size="lg"  data-ajax-popup="true" class=" btn-sm btn btn-warning d-none" data-title="<?php echo e(__('Employee Payslip')); ?>">' +
                                        '<?php echo e(__('Payslip')); ?>' + '</a> ';
                                }
                                ...
                                if (valueOfElement[7] != 0 && valueOfElement[6] == "UnPaid") {
                                    var edit =
                                        '<a href="#" data-url="<?php echo e(url('payslip/editemployee/')); ?>/' +
                                        payslip_id +
                                        '"  data-ajax-popup="true" class="btn-sm btn btn-info d-none" data-title="<?php echo e(__('Edit Employee salary')); ?>">' +
                                        '<?php echo e(__('Edit')); ?>' + '</a>';
                                } else {
                                    var edit = '';
                                }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm-junglesafari/resources/views/payslip/index.blade.php ENDPATH**/ ?>