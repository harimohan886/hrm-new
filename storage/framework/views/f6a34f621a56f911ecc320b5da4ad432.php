                    ...
                    <div class="card em-card">
                        ...
                        <div class="card-body employee-detail-create-body">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <?php echo Form::label('shift_code', __('Shift'), ['class' => 'form-label']); ?>

                                    <?php echo Form::select('shift_code', $manageShift, null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Select Shift']); ?>

                                </div>

                                
                                <div class="form-group">
                                    <?php echo Form::label('enable_ot', __('Overtime'), ['class' => 'form-label']); ?>

                                    <?php echo Form::select('enable_ot', ['Enabled' => 'Enabled', 'Disabled' => 'Disabled'], null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Select OT']); ?>

                                </div>

                                
                                <div class="form-group">
                                    <?php echo Form::label('enable_weekoff', __('Weekoff'), ['class' => 'form-label']); ?>

                                    <?php echo Form::select('enable_weekoff', ['Enabled' => 'Enabled (For Two Days)', 'Disabled' => 'Disabled (For One Day)'], null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Select Weekoff']); ?>

                                </div>

                                 
                                 <div class="form-group">
                                    <?php echo Form::label('enable_letter', __('Letter'), ['class' => 'form-label']); ?>

                                    <?php echo Form::select('enable_letter', ['Enabled' => 'Enabled', 'Disabled' => 'Disabled'], null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Select Letters']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm-junglesafari/resources/views/employee/create.blade.php ENDPATH**/ ?>