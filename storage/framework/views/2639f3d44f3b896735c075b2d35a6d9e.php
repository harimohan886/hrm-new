                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <?php echo Form::label('shift_code', 'Shift Code', ['class' => 'form-label']); ?>

                                        <?php echo Form::select('shift_code', $manageShift, $selectedShift, [
                                            'class' => 'form-control',
                                            'id' => 'shift_code',
                                            'required' => 'required'
                                        ]); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        <?php echo Form::label('enable_ot', 'Overtime', ['class' => 'form-label']); ?>

                                        <?php echo Form::select('enable_ot', ['Enabled' => 'Enabled', 'Disabled' => 'Disabled'], $selectedOvertime, [
                                            'class' => 'form-control',
                                            'id' => 'enable_ot',
                                            'required' => 'required'
                                        ]); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        <?php echo Form::label('enable_weekoff', 'WeekOff', ['class' => 'form-label']); ?>

                                        <?php echo Form::select('enable_weekoff', ['Enabled' => 'Enabled (For Two Days)', 'Disabled' => 'Disabled (For One Day)'], $selectedWeekoff, [
                                            'class' => 'form-control',
                                            'id' => 'enable_weekoff',
                                            'required' => 'required'
                                        ]); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        <?php echo Form::label('enable_letter', 'Letter', ['class' => 'form-label']); ?>

                                        <?php echo Form::select('enable_letter', ['Enabled' => 'Enabled', 'Disabled' => 'Disabled'], $selectedLetter, [
                                            'class' => 'form-control',
                                            'id' => 'enable_letter',
                                            'required' => 'required'
                                        ]); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        <?php echo Form::label('is_active', 'Employee Status', ['class' => 'form-label']); ?>

                                        <?php echo Form::select('is_active', ['1' => 'Active', '0' => 'Inactive'], $selectedEmployeeStatus, [
                                                'class' => 'form-control',
                                                'id' => 'is_active',
                                                'required' => 'required'
                                        ]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm-junglesafari/resources/views/employee/edit.blade.php ENDPATH**/ ?>