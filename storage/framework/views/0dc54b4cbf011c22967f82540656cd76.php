...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="useradd-2">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0"><?php echo e(__('Sync Data')); ?></h5>
                            <small> <?php echo e(__('For Sync Device Attendance Data into HRM DB')); ?></small>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('sync.data')); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/hrm-systemjan8/resources/views/user/profile.blade.php ENDPATH**/ ?>