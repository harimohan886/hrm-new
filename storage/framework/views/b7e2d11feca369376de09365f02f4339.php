...
<div class="report-header">
    <p style="color:#f21177 !important; margin-left:140px !important;"><b>Report from : 01-<?php echo e($month); ?>-<?php echo e($year); ?> To : 31-<?php echo e($month); ?>-<?php echo e($year); ?></b></p>
...
<table class="report-container <?php echo $backgroundClass; ?>">
    <thead>
        <tr class="table-rodd">
            <th colspan="4" class="text-left">Dept.: <?php echo e($department); ?></th>
            <th colspan="10" class="text-left">Design: <?php echo e($designation); ?></th>
            <th colspan="4">Attendance Month OF: <?php echo e($month); ?> - <?php echo e($year); ?></th>
        </tr>
    ...
    <tbody>
        <tr class="table-rodd">
            <td class="no-border"><b>#EMP00000<?php echo e($employee->id); ?></b></td>
            <td colspan="8" class="no-border"><b><?php echo e($employee->name); ?></b></td>
            <td class="no-border" style="color:green !important;"><b><?php echo e($daysData['present']); ?></b></td>
            <td class="no-border" style="color:brown !important;"><b><?php echo e($daysData['holidays']); ?></b></td>
            <td class="no-border" style="color:blue !important;"><b><?php echo e($daysData['weekoffs']); ?></b></td>
            <td class="no-border" style="color:red !important;"><b><?php echo e($daysData['absent']); ?></b></td>
            <td class="no-border" style="color:red !important;"><b><?php echo e($daysData['leave']); ?></b></td>
            <td class="no-border" style="color:green !important;"><b><?php echo e($daysData['present']); ?></b></td>
            <td class="no-border" style="color:red !important;"><b><?php echo e($formattedLate); ?></b></td>
            <td class="no-border" style="color:green !important;"><b><?php echo e($totalHours); ?></b></td>
            <td class="no-border" style="color:#e31bc5 !important;"><b><?php echo e($employee->enable_ot=="Enabled" ? $formattedot : '00:00'); ?></b></td>
        </tr>
    </tbody>
</table>
    ...
    <thead>
        <tr style="background-color:white !important;">
            ...
            <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                <th><?php echo e(str_pad($day, 2, '0', STR_PAD_LEFT)); ?></th>
            <?php endfor; ?>
        </tr>
    </thead>
    <tbody>
        <tr class="table-rodd">
            ...
            <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                ...
                ?>
                <td><?php echo e($formattedTimeIn); ?></td>
            <?php endfor; ?>
        </tr>
        <tr class="table-rodd">
        ...
        <tr class="table-rodd">
            ...
            <td><?php echo e(getDayTotalHours($date, $formattedOts, $formattedTimeIn, $shift_start_time, $shift, $employee->enable_ot, $employee->id, $checkingLate, $checkingEarlygoing )); ?></td>
            <?php endfor; ?>
        </tr>
        <tr class="table-rodd">
            ...
            <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                <?php
                    ...
                    $formattedOts = $timeOtObj->format('H:i');
                ?>
                <td><?php echo e($employee->enable_ot=="Enabled" ? $formattedOts : '00:00'); ?></td>
            <?php endfor; ?>
        </tr>
        <tr class="table-rodd">
            ...
            <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                ...
                ?>
                <td style="color: <?php echo e($color); ?> !important;"><b><?php echo e($status); ?></b></td>
            <?php endfor; ?>
        </tr>
        <tr class="table-rodd">
            <td style="color:#f21177 !important;"><b>Shift</b></td>
            <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                <td><?php echo e($employee->shift_code); ?></td>
            <?php endfor; ?>
        </tr>
    </tbody>
</table>
...
<?php /**PATH /var/www/hrm-junglesafari/resources/views/report/monthlyAttendancePdf.blade.php ENDPATH**/ ?>