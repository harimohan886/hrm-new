...
<?php $__env->startSection('action-button'); ?>
    ...
    <div class="text-end mb-3">
        <div class="d-flex justify-content-end drp-languages">
            <?php if($employee->enable_letter=="Enabled"): ?>
                    ...
                    <div class="card">
                        <div class="card-body employee-detail-body fulls-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold"><?php echo e(__('Shift Mode')); ?> :</strong>
                                        <span><?php echo e($employee->shift_code); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/hrm-systemjan8/resources/views/employee/show.blade.php ENDPATH**/ ?>